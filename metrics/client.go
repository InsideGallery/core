...
var (
	...
	registryMu sync.RWMutex           //nolint:gochecknoglobals // package-level processor registry
	registry   = map[string]Factory{} //nolint:gochecknoglobals // registered by processor packages
)
